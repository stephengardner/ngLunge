...
module.exports = function (grunt) {
	...
	grunt.initConfig({
		...
		watch: {
			...
			injectJS: {
				files: [
					...
					'!<%= yeoman.client %>/{app,components,modules}/**/*.spec.js',
					'!<%= yeoman.client %>/{app,components,modules}/**/*.mock.js',
					'!<%= yeoman.client %>/app/app.js'],
				tasks: ['injector:scripts']
			},
			injectCss: {
				files: [
					'<%= yeoman.client %>/{app,components,modules}/**/*.css'
				],
				tasks: ['injector:css']
			},
			mochaTest: {
			...
			livereload: {
				files: [
					'{.tmp,<%= yeoman.client %>}/{app,components,modules}/**/*.css',
					'{.tmp,<%= yeoman.client %>}/{app,components,modules}/**/*.html',
					'{.tmp,<%= yeoman.client %>}/{app,components,modules}/**/*.js',
					'!{.tmp,<%= yeoman.client %>}{app,components,modules}/**/*.spec.js',
					'!{.tmp,<%= yeoman.client %>}/{app,components,modules}/**/*.mock.js',
		...
		// augie added this whole block 1/2/15
		/*
		 uglify: {
		 options:{mangle:false},
		 dist: {
		 files: {
		 '<%= yeoman.client %>/scripts/scripts.js': [
		...
		// not using imgmin since some image profile pictures are stored as-is
		// we can potentially reference these new minified images in the future, but whatever
		//imagemin: {
		//	dist: {
		//		files: [{
		//			expand: true,
		...
		ngtemplates: {
			...
			main: {
				cwd: '<%= yeoman.client %>',
				src: ['{app,components,modules}/**/*.html'],
		...
		copy: {
			...
			styles: {
				...
				cwd: '<%= yeoman.client %>',
				dest: '.tmp/',
				src: ['{app,components,modules}/**/*.css']
			}
		},
		buildcontrol: {
			options: {
			...
			scripts: {
				...
				files: {
					'<%= yeoman.client %>/index.html': [
						[
							'{.tmp,<%= yeoman.client %>}/{app,components,modules}/**/*.module.js',
							'{.tmp,<%= yeoman.client %>}/{app,components,modules}/**/(.module)*.js',
							'{.tmp,<%= yeoman.client %>}/{app,components,modules}/**/!(account)*.js',
